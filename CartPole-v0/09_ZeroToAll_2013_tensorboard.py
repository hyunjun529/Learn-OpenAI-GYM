'''
https://github.com/hunkim/ReinforcementZeroToAll/blob/master/07_2_dqn_2013_cartpole.py
...
class DQN:
    ...
    def update(self, x_stack, y_stack):
        return self.session.run([self._merged, self._loss, self._train], feed_dict={
...
def main():
    ...
    with tf.Session() as sess:
        ...
        # h529
        mainDQN._merged = tf.summary.merge_all()
        train_writer  = tf.summary.FileWriter('./log/09', sess.graph)
        ...
        for episode in range(max_episodes):
            ...
            if episode % 10 == 1:  # train every 10 episodes
                ...
                for _ in range(50):
                    ...
                    summary, loss, _ = simple_replay_train(mainDQN, minibatch)
                print("Loss: ", loss)
